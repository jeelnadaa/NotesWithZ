...
export const Sidebar = ({
    ...
    return (
        <aside className="w-80 h-full bg-cream-100/80 dark:bg-dark-sidebar/90 backdrop-blur-xl flex flex-col p-8 flex-shrink-0 font-sans z-0 relative transition-colors duration-500 rounded-[32px] border border-white/40 dark:border-white/5 shadow-2xl ml-4 my-4">
            {/* Header */}
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3 cursor-pointer group" onClick={() => onSelectFolder(null)}>
